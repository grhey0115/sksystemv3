...
export default function ViewProfile() {
    const { user, personalInformation = {}, educationalBackground = {}, additionalInformation = {} } = usePage().props;
    ...
    const handleProfileUpdate = (e) => {
        ...
        formData.append('course', data.course || educationalBackground.course || '');
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <div className="flex justify-between">
                                        ...
                                        <p>{data.current_status || 'N/A'}</p>
                                    </div>
                                    <div className="flex justify-between mt-2">
                                        <p className="text-gray-600">Year Graduated</p>
                                        <p>{data.year_graduated || 'N/A'}</p>
                                    </div>
                                    <div className="flex justify-between mt-2">
